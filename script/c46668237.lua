...
function c46668237.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	and eg:IsExists(c46668237.cfilter,1,nil,tp) 
	-- (3) 战破也能特召
	--and bit.band(r,REASON_DESTROY+REASON_EFFECT)==REASON_DESTROY+REASON_EFFECT
	and bit.band(r,REASON_DESTROY)==REASON_DESTROY
end
